...
export default function Article() {
    return(
        <div className="w-full text-gray-400 order-1 lg:order-2 lg:w-6/12">
            <p>
            ...
            <h4 className="text-black text-2xl font-semibold pb-5">
            ...
            <h4 className="text-black text-2xl font-semibold py-5">
